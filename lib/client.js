window.__ModuleLoader__.load({
  ...
  factory: (require) => {
    ...
    function renderGroupHeader(g, gi, jump, C) {
      return react_jsx_runtime.jsx("div", {
        style: { padding: "1px 4px 2px", height: 18, display: "flex", alignItems: "center" },
        children: react_jsx_runtime.jsx("span", {
          onClick: function (e) {
            e.stopPropagation();
            if (!g.userKey) return;
          ...
          onMouseEnter: function (e) { e.currentTarget.style.background = C.hover; },
          onMouseLeave: function (e) { e.currentTarget.style.background = "transparent"; },
          style: { fontSize: 11, color: C.muted, fontWeight: 600, cursor: "pointer", padding: "1px 5px", borderRadius: 4, transition: "background 0.15s ease" },
          children: g.time || " "
        })
      }, "g-h-" + gi);
    }
