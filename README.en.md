...
- **Jumping**: click an outline heading or a group header to jump to it; click the breadcrumb to jump to the section you are inside
...
- **Level filter**: click the `1`–`6` chips to toggle levels; the 层级 button collapses/expands that row
